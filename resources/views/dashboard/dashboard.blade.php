...
@section('content')
    ...
    <div class="mx-6 grid grid-cols-1 xl:grid-cols-3 grid-rows-1 grid-flow-row-dense gap-6">
        <div class="xl:col-span-2">
            <div class="card h-full shadow">
                ...
                <div class="relative overflow-x-auto">
                    ...
                    <table class="text-left w-full whitespace-nowrap">
                        <thead class="text-gray-700">
                            <tr>
                                <th class="border-b bg-gray-100 px-6 py-3">Project name</th>
                                <th class="border-b bg-gray-100 px-6 py-3">Hours</th>
                                <th class="border-b bg-gray-100 px-6 py-3">Priority</th>
                                <th class="border-b bg-gray-100 px-6 py-3">Members</th>
                                <th class="border-b bg-gray-100 px-6 py-3">Progress</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <h5 class="mb-1 ml-4"><a href="#!">Dropbox Design
                                                System</a></h5>
                                    </div>
                                </td>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <span
                                        class="bg-yellow-100 px-2 py-1 text-yellow-900 text-sm font-medium rounded-md inline-block whitespace-nowrap text-center">Medium</span>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="-space-x-5">
                                ...
                                <td class="border-b border-gray-300 py-3 px-6 pr-6 text-left">
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <h5 class="ml-4"><a href="#!">Slack Team UI Design</a>
                                        </h5>
                                    </div>
                                </td>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <span
                                        class="bg-red-100 px-2 py-1 text-red-900 text-sm font-medium rounded-md inline-block whitespace-nowrap text-center">High</span>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="-space-x-5">
                                        <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                            ...
                            <tr>
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <span
                                        class="bg-cyan-100 px-2 py-1 text-cyan-900 text-sm font-medium rounded-md inline-block whitespace-nowrap text-center">Low</span>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="-space-x-5">
                                        <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <h5 class="ml-4"><a href="#!">3D Character
                                                Modelling</a></h5>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <h5 class="ml-4"><a href="#!">Webapp Design System</a>
                                        </h5>
                                    </div>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">89
                                ...
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <span
                                        class="bg-green-100 px-2 py-1 text-green-900 text-sm font-medium rounded-md inline-block whitespace-nowrap text-center">Track</span>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="-space-x-5">
                                        <img class="relative inline-block object-cover w-8 h-8 rounded-full border-white border-2"
                            ...
                            <tr>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <h5 class="ml-4"><a href="#!">Github Event Design</a>
                                        </h5>
                                    </div>
                                </td>
                                <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                ...
                <div class="px-5 py-3 flex justify-center items-center gap-3">
                    <a href="#!"
    ...
    <div class="mx-6 my-6 grid grid-cols-1 xl:grid-cols-2 grid-rows-1 grid-flow-row-dense gap-6">
        <div>
            <div class="card h-full shadow">
            ...
            <div class="relative overflow-x-auto" data-simplebar="" style="max-height: 380px">
                ...
                <table class="text-left w-full whitespace-nowrap">
                    <thead class="text-gray-700">
                        <tr>
                            <th class="border-b bg-gray-100 px-6 py-3">Name</th>
                            <th class="border-b bg-gray-100 px-6 py-3">Role</th>
                            <th class="border-b bg-gray-100 px-6 py-3">Last Activity</th>
                            <th class="border-b bg-gray-100 px-6 py-3"></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 leading-4">
                                        ...
                                        <p class="text-gray-500">anita@example.com</p>
                                    </div>
                                </div>
                            </td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Front
                                End Developer</td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">3
                                May, 2023</td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="dropdown leading-4">
                            ...
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 leading-4">
                                        ...
                                        <p class="text-gray-500">jituchauhan@example.com</p>
                                    </div>
                                </div>
                            </td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                        ...
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 leading-4">
                                        <h5 class="mb-1"><a href="#!">Sandeep Chauhan</a>
                                        </h5>
                                        <p class="text-gray-500">sandeepchauhan@example.com</p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 leading-4">
                                        ...
                                        <p class="text-gray-500">amandadarnell@example.com</p>
                                    </div>
                                </div>
                            </td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                        ...
                        <tr>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 leading-4">
                                        <h5 class="mb-1"><a href="#!">Patricia Murrill</a>
                                        </h5>
                                        <p class="text-gray-500">patriciamurrill@example.com</p>
                                    </div>
                                </div>
                            </td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                            ...
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3 leading-4">
                                        ...
                                        <p class="text-gray-500">darshininair@example.com</p>
                                    </div>
                                </div>
                            </td>
                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Front
